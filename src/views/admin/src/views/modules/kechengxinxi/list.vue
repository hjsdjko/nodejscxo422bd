		...
		<template v-if="showFlag">
			...
			<div :style='{"padding":"0","borderColor":"rgba(48,138,196,.3)","margin":"10px 0 0","borderRadius":"10px 10px 4px 4px","background":"rgba(255,255,255,1)","borderWidth":"1px 0","width":"calc(100% - 250px)","borderStyle":"solid"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' :sortable='true' prop="xuexiziliao" label="学习资料">
						<template slot-scope="scope">
							<el-button v-if="scope.row.xuexiziliao" type="text" size="small" @click="download(scope.row.xuexiziliao)">下载</el-button>
                            <span v-else >无</span>
						</template>
					</el-table-column>
					<el-table-column :resizable='true' :sortable='true'  
