<template>
	<div class="addEdit-block" :style='{"border":"0px solid #ddd","padding":"0px 7%","margin":"40px auto","color":"#333","borderRadius":"10px","background":"none","width":"calc(100% - 20px)","fontSize":"16px"}'>
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="在线测试名称" prop="name">
					<el-input v-model="ruleForm.name" placeholder="在线测试名称" clearable  :readonly="ro.name"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="在线测试名称" prop="name">
					<el-input v-model="ruleForm.name" placeholder="在线测试名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="在线测试时长(分钟)" prop="time">
					<el-input v-model.number="ruleForm.time" placeholder="在线测试时长(分钟)" clearable  :readonly="ro.time"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="在线测试时长(分钟)" prop="time">
					<el-input v-model="ruleForm.time" placeholder="在线测试时长(分钟)" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="select" v-if="type!='info'"  label="在线测试状态" prop="status">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="在线测试状态" prop="status">
