<template>
	<div class="navbar">
		<div class="title" :style='{"width":"1200px","margin":"0 auto","textAlign":"center","background":"none","display":"block","order":"3"}'>
			...
			<span class="title-name" :style='{"padding":"0 0 0 12px","lineHeight":"44px","fontSize":"22px","color":"#fff","fontWeight":"500"}'>{{this.$project.projectName}}</span>
		</div>
		<!--
		...
		<el-dropdown @command="handleCommand" trigger="click" :style='{"fontSize":"inherit","position":"absolute","color":"inherit","left":"10px","display":"inline-block"}'>
		  <div class="el-dropdown-link" :style='{"alignItems":"center","display":"flex"}'>
		    <el-image v-if="user" :style='{"width":"32px","margin":"0 10px 0 0","objectFit":"cover","borderRadius":"100%","display":"inline-block","height":"32px"}' :src="avatar?this.$base.url + avatar : require('@/assets/img/avator.png')" fit="cover"></el-image>
