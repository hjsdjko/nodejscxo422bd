	...
	<div style="height: 100%;">
		<el-main :style='"horizontal" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"10px 0 0 64px","margin":"0","position":"relative","background":"#13a1e6","display":"block"} : {"minHeight":"100%","padding":"10px 0 30px 210px","margin":"0","position":"relative","background":"#13a1e6","display":"block"}) : "")) : {"minHeight":"100%","padding":"0px 0 30px","margin":"0","position":"relative","background":"#f6f6f6"}'>
			...
			<template v-if="'horizontal' == 'horizontal'">
			  ...
			  <template v-if="2 == 2">
				<index-aside :style='{"padding":"18px 10px 0","borderColor":"#efefef","margin":"0 auto","background":"#262626","borderWidth":"0 0 0px 0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'></index-aside>
			  </template>
			</template>
			
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"padding":"10px 20px ","boxShadow":"inset 0px 0px 16px 0px #093b5b","margin":"0 auto","borderColor":"#eee","color":"#fff","borderWidth":"0 0 0px 0","background":"#308ac4","width":"calc(100% - 0px)","fontSize":"16px","borderStyle":"solid"}' class="bread-crumbs"></bread-crumbs>
