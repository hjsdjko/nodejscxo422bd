<template>
  <div>
		<div class="top-content">
			...
			<div class="top-content-center" v-cloak>距离在线测试结束还有 <el-tag type="danger">{{this.hour}}</el-tag> 时 <el-tag
		...
		<el-card v-if="end" style="width: 90%;margin: 10px auto;">
			<div style="width: 100%;display: flex;flex-direction: column;align-items: center;">
				<div>
					<div class="question-title">在线测试成绩：<el-tag type="danger">{{scoreChange()}}</el-tag> 分</div>
				</div>
				<div class="question-btn">
					<el-button v-if="!isSubmit" type="primary" @click="isSubmit=true">查看解析</el-button>
					<el-button type="success" @click="doneExam(1)">结束在线测试</el-button>
				</div>
			</div>
		</el-card>
