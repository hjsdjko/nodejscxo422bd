...
<div class="forum-preview" :style='{"width":"100%","padding":"30px 10% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    <div :style='{"padding":"0px 0 0","margin":"0px auto","borderColor":"#ddd","textAlign":"left","background":"none","borderWidth":"0 0 2px","width":"100%","borderStyle":"solid","height":"48px"}'>
		<div :style='{"padding":"0 24px","borderColor":"#fb3f52","color":"#fb3f52","textAlign":"left","background":"none","borderWidth":"0 0 4px","display":"inline-block","width":"auto","fontSize":"22px","lineHeight":"44px","borderStyle":"solid","fontWeight":"600"}'>论坛信息</div>
	</div>
