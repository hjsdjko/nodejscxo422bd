...
<div>
	...
	<div class="detail-preview" :style='{"padding":"10px 10% 0","margin":"10px auto","alignItems":"flex-start","flexWrap":"wrap","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
		<div class="attr" :style='{"border":"0px solid #e9e9e9","padding":"0","margin":"0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"space-between","order":"2"}'>
			...
			<div class="info" :style='{"width":"100%","padding":"0px","margin":"0","background":"#fff","order":"2"}'>
				...
				<div class="item" :style='{"padding":"0 10px","margin":"0 0 4px 0","borderColor":"#f3f3f3","background":"#fff","borderWidth":"0 0 1px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"36px","height":"36px"}'>课程分类</div>
				...
				<div class="item" :style='{"padding":"0 10px","margin":"0 0 4px 0","borderColor":"#f3f3f3","background":"#fff","borderWidth":"0 0 1px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"36px","height":"36px"}'>教师工号</div>
				...
				<div class="item" :style='{"padding":"0 10px","margin":"0 0 4px 0","borderColor":"#f3f3f3","background":"#fff","borderWidth":"0 0 1px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"36px","height":"36px"}'>学习资料</div>
					<el-button :style='{"padding":"0px 10px","margin":"4px 0 0","color":"#ff777f","borderRadius":"20px","textAlign":"center","background":"none","width":"auto","lineHeight":"32px","fontSize":"14px","textDecoration":"none","height":"32px"}' @click="download(detail.xuexiziliao)">点击下载</el-button>
				</div>
				<div class="btn" :style='{"padding":"10px 20px","flexWrap":"wrap","display":"flex"}'>
					...
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#333","borderRadius":"2px","background":"#f5340030","width":"auto","lineHeight":"36px","fontSize":"14px","height":"36px"}' v-if="btnAuth('kechengxinxi','私聊')&&detail.id!=mid" @click="chatClick">联系TA</el-button>
				</div>
			</div>
		</div>
		...
		<video :style='{"border":"0","minHeight":"300px","margin":"40px auto 40px","borderRadius":"4px","maxHeight":"480px","display":"block","width":"100%","order":"3"}' :src="baseUrl +  detail.kechengshipin" controls="controls">
			您的浏览器不支持视频播放
		</video>
		...
		<div class="detail2" :style='{"border":"0px solid #ddd","padding":"0px","margin":"40px 0","borderRadius":"0px","background":"#fff","width":"100%","order":"10"}'>
			<div :style='{"border":"1px solid #f6f6f6","padding":"0","margin":"0 0 16px 0","borderColor":"#eee","borderRadius":"0px","background":"none","borderWidth":"0 0 2px","borderStyle":"solid","height":"48px"}'>
				<div :style='{"padding":"0 24px","borderColor":"#fb3f52","color":"#fb3f52","borderWidth":"0 0 4px","display":"inline-block","fontSize":"22px","lineHeight":"44px","borderStyle":"solid","fontWeight":"600"}'>课程描述</div>
			</div>
			<div :style='{"color":"#666","padding":"0 24px","background":"#fff"}' v-html="detail.kechengmiaoshu"></div>
